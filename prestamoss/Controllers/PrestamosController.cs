...
namespace prestamoss.Controllers
{
    public class PrestamosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Capital,Interes,Periodo,ClientesId")] Prestamos prestamos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Capital,Interes,Periodo,ClientesId")] Prestamos prestamos)
        {
            if (ModelState.IsValid)
            {
